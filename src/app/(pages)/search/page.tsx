...
import { FaBridgeCircleCheck, FaBriefcase, FaLocationDot, FaUserTie } from "react-icons/fa6";
    ...
    <>
      ...
      <div className="py-[60px]">
        <div className="contain">
          ...
          <div
            className="py-[10px] px-[20px] rounded-[8px] flex flex-wrap gap-[12px] mb-[30px]"
            ...
            <div className="rounded-[8px] border-[1px] border-[#DEDEDE] card-item relative overflow-hidden">
              ...
              <div className="p-[20px] relative">
                ...
                <div className="font-[400] text-[14px] text-[#121212] mb-[6px] text-center">
                  <FaUserTie className="mr-[4px] text-[16px]"/> Fresher
                </div>
                <div className="font-[400] text-[14px] text-[#121212] mb-[6px] text-center">
                  <FaBriefcase className="mr-[4px] text-[16px]"/> Tại văn phòng
                 
                </div>
                <div className="font-[400] text-[14px] text-[#121212] mb-[12px] text-center">
                  <FaLocationDot className="mr-[4px] text-[16px]"/> Ha Noi
                </div>
                <div className="flex items-center justify-center gap-[8px]">
                  <span className="border border-[#DEDEDE] rounded-[20px] py-[6px] px-[16px] font-[400] text-[12px] text-[#414042] inline-block">
                    ReactJS
                  </span>
                  <span className="border border-[#DEDEDE] rounded-[20px] py-[6px] px-[16px] font-[400] text-[12px] text-[#414042] inline-block">
                    NextJS
